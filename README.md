...
2. Baskerville - Intel Xeon CPUs and Nvidia A100 GPUs **(no longer available as of April 2026)**
3. JADE2 - Intel Xeon CPUs and Nvidia V100 GPUs
4. Dawn - Intel Xeon CPUs and Intel Data Centre Max 1550 GPUs
5. Isambard-AI - Nvidia Grace Hopper GH200 superchips (ARM CPUs, H100 GPUs)
...
This repository is primarily organised by compute resource (e.g. Baskerville, DAWN, Isambard-AI, etc.) but also contains some material that is applicable to multiple systems stored in the `example_workflows` directory.
