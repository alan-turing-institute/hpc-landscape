...
## 7. Log in to the secondary node.
...
## 8. Configure the secondary node.
...
## 9. Execute the example script on the primary node:
...
## 10. Execute the example script on the secondary node:
